...
\begin{titlepage}
    \begin{center}
        \textbf{Latitudinal effects on weight and age dependent survival of Red fox \emph{Vulpes vulpes}} \\
        \vspace*{2cm}
        \emph{Analysis of harvested foxes reveal demographic traits.} \\
        \vspace*{5cm}
