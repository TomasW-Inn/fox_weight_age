...
We evaluated the effect of area, sex and age on carcass weight, and used a general linear model assuming a normal distribution with a unity link. We separately analyzed the effect of area and sex for adults and sub-adults. For adults, age was included as a continuous covariate to account for continued weight gain beyond the first year. Sub-adults represent a single first-year age class with limited age variation within the class, so age was not included in the sub-adult model. We tested for a sex $\times$ region interaction in both models to evaluate whether the latitudinal weight gradient differed between males and females. Area and sex were treated as categorical variables. We used residual diagnostics to validate models with the package DHARMa \citep{hartigDHARMaResidualDiagnostics2022}.
...
Carcass weights of red foxes decreased consistently from the southernmost to the northernmost region in both adults and sub-adults, and for both sexes (Figure~\ref{ref:Adfig}, Tables~\ref{ref:Adweight}~\&~\ref{ref:Juvweight}). Residual diagnostics showed no evidence of heteroscedasticity or systematic departures from normality in either model \citep{hartigDHARMaResidualDiagnostics2022}.

In adults, foxes in the South were on average 1.64~kg heavier than foxes in the North (Table~\ref{ref:Adweight}), exceeding the sex difference of 1.21~kg between males and females. The intermediate regions followed a clear gradient, with North Central (+0.42~kg) and South Central (+0.58~kg) both significantly heavier than the North reference. Adults also increased in weight with age at approximately 69~g per year (Table~\ref{ref:Adweight}), though this effect was small relative to the regional and sex differences.

In sub-adults, the latitudinal gradient was equally pronounced: foxes in the South were 1.47~kg heavier than those in the North, again exceeding the sex difference of 0.98~kg between males and females (Table~\ref{ref:Juvweight}). Age was not included in the sub-adult model because sub-adults represent a single first-year age class with limited age variation.

The latitudinal effect on weight was therefore larger than the effect of sex in both age classes, and the pattern was consistent across males and females. We did not test for a sex $\times$ region interaction, and potential differences in the steepness of the latitudinal weight gradient between sexes remain to be explored.
