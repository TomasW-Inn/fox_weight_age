...
\begin{figure}[!htbp]
  ...
  \captionsetup{font=scriptsize}
  \caption{The distribution of data on carcass weights of adult foxes aged 1-4 years in a latitudinal gradient of four regions in Sweden.}
  \label{ref:Adfig}
\end{figure}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[scale=0.35]{survival_v5.pdf}
  \captionsetup{font=scriptsize}
